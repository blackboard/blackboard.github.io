...
To do this, you will need your client ID and your secret. See the [Getting Started Guide](/allly/gettingstarted.html) for information on how to request your credentials. At the top of the page you will see two text boxes, one for each of these values. Simply plug them in and you are all ready to.
