...
<hr />
<p>Blackboard Learn was the first Learning Management System to be certified for
...
Store in Blackboard Learn.</p>

<p>If you are self-hosted, you will need to make a configuration change in order
...
protected under the requirements as set forth in GDPR.</p>

<p>As a user with Administrator privledges, login to Blackboard Learn and access
...
![select-building-blocks-from-building-blocks-module.png](/images/114053.png)

<p>On the subsequent page, select installed Tools.</p>

![select-installed-tools.png](/images/114055.png)

<p>From the Manage Building Blocks page, navigate through the paging tools until
...
icon and select 'Settings' from the menu.</p>

![select-settings-from-the-telemetry-building-block-context-menu.png](/images/114056.png)

<p>On the Settings page, you will notice two entries. Caliper Providers is to
...
the corresponding link.</p>

![select-caliper-event-stores.png](/images/114057.png)

<p>On this screen, you can see all of the currently registered Event Stores. You
...
directly to your event store.</p>

![select-add-event-store.png](/images/114058.png)
...
![fill-out-the-event-store-registration-form.png](/images/114059.png)
